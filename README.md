...
- **TypeScript** 4.9.x - типізована надбудова JavaScript
...
- **Babel** (під капотом CRA) - транспіляція JavaScript/TypeScript

### Styling

- **Tailwind CSS** 4.x - utility-first CSS фреймворк
- **PostCSS** - обробка CSS
- **Autoprefixer** - автоматичні vendor prefixes

### Internationalization

- **i18next** - фреймворк для інтернаціоналізації
- **react-i18next** - React інтеграція для i18next

### UI Components

- **React Icons** - колекція іконок
...
- **TypeScript** типи для React, React DOM, React Router
...
Помилки lint та TypeScript відображаются в консолі.
...
TypeScript код компілюється в JavaScript, збірка мінімізована, а імена файлів включають хеші.  
...
**Примітка: це односторонне повноваження. Після `eject` ви не зможете повернутись назад!**

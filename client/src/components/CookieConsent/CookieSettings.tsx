...
export type CookieKey = 'necessary' | 'analytics' | 'marketing' | 'preferences';
...
export default function CookieSettings({ onSave, onClose }: CookieSettingsProps) {
  ...
  const handleToggle = (key: CookieKey) => {
  ...
  const handleAcceptAll = () => {
    const allAccepted: CookieSettingsState = {
      necessary: true,
      analytics: true,
      marketing: true,
      preferences: true,
      ...
      <div className="cookie-settings-modal">
        <div className="cookie-settings-container">
          <div className="cookie-settings-header">
            ...
            <button onClick={onClose} className="cookie-close-btn">
              ✕
            </button>
          </div>

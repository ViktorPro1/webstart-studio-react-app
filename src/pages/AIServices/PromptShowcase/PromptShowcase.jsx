        ...
        <div className="prompt-showcase">
            <div className="prompt-showcase__hero">
                ...
                <div className="prompt-showcase__info-box">
                    <p>
                        💡 Кожне зображення створене за унікальним промптом, написаним спеціально під запит клієнта.
                        <br />
                        Хочете такий же результат? <a href="/prompt-editor">Замовте свій промпт</a>
                    </p>
                </div>
            </div>

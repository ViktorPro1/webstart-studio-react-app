      ...
      sections: [
        {
          ...
          items: [
            { text: '⚡ Vite 6.0.7 - швидкий build tool нового покоління', icon: <Zap /> },
            { text: '@vitejs/plugin-react 4.3.4 - офіційний React плагін', icon: <Package /> },
            ...
            { text: 'Автоматична перевірка React hooks', icon: <CheckCircle /> },
            { text: 'Правила для TypeScript та React компонентів', icon: <Code /> },
          ]
        },
        {
          category: 'Changed',
          ...
          items: [
            ...
            { text: 'Оновлено конфігураційні файли (vite.config.ts)', icon: <Wrench /> },
          ]
        },
        {
          category: 'Removed',
        ...
        },
        {
          ...
          items: [
            { text: 'setState в useEffect (переведено на lazy initialization)', icon: <CheckCircle /> },
            { text: 'Видалено TypeScript any типи', icon: <Code /> },
            { text: 'Виправлено empty block statements', icon: <CheckCircle /> },
            { text: 'Math.random в рендері компонентів', icon: <CheckCircle /> },
          ]
        }
      ]
    },
      ...
      sections: [
        {
          ...
          items: [
            ...
            { text: 'Додано типи для React (@types/react@19.2.7)', icon: <Package /> },
            ...
            { text: 'Підтримка української та англійської мов', icon: <Globe /> },
            { text: 'React Icons 5.5.0 та Lucide React 0.263.1', icon: <Palette /> },
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'Оновлено структуру проєкту для TypeScript', icon: <RefreshCw /> },
            { text: 'Покращено типобезпеку по всьому проєкту', icon: <Shield /> },
          ]
        },
        {
          category: 'Technical',
          ...
          items: [
            { text: 'Створено tsconfig.json з оптимальними налаштуваннями', icon: <Wrench /> },
            { text: 'Створено tailwind.config.js та postcss.config.js', icon: <Wrench /> },
            { text: 'Додано папки /src/types, /src/contexts, /src/utils', icon: <Package /> },
          ]
        }
      ]
    },
      ...
      sections: [
        {
          ...
          items: [
            ...
            { text: 'Головна сторінка з інформацією про платформу', icon: <Package /> },
            { text: 'Повна навігаційна структура (Header, Sidebar, Footer)', icon: <Package /> },
            { text: 'Адаптивний дизайн для всіх пристроїв', icon: <Palette /> },
            { text: 'React Router v6 для SPA навігації', icon: <Code /> },
            { text: 'Сторінки AI Automation та Google Ads Setup', icon: <Package /> },
            { text: 'Розділ Blog з статтями', icon: <Package /> },
            { text: 'Інформаційні сторінки (FAQ, Testimonials, тощо)', icon: <Package /> },
          ]
        },
        {
          category: 'Technical',
          ...
          items: [
            ...
            { text: 'React 18.x з функціональними компонентами', icon: <Code /> },
  ...
  return (
    <div className="updates-container">
      <Helmet>
        ...
        <meta name="description" content="Історія оновлень та нових функцій платформи Web Start Studio" />
      </Helmet>
      ...
      <div className="updates-header">
        <div className="updates-header-content">
          ...
          <p className="updates-subtitle">
            Слідкуйте за розвитком платформи. <br />Кожне оновлення робить WebStart Studio краще та продуктивніше.
          </p>
        </div>
      </div>
            ...
            <div key={version.version} className="updates-version-block">
              <div className="updates-version-header">
                <div className="updates-version-badge">
                  ...
                  <span className="updates-version-number">v{version.version}</span>
                </div>
              ...
              <div className="updates-sections">
                {version.sections.map((section, sectionIndex) => (
                  <div key={sectionIndex} className="updates-section">
                    <div className={`updates-section-header ${getCategoryColor(section.category)}`}>
                      {section.icon}
                      <h3 className="updates-section-title">{section.category}</h3>
                      <span className="updates-section-count">{section.items.length}</span>
                    </div>
            ...
            <div className="updates-stats">
              ...
              <div className="updates-stat">
                <span className="updates-stat-number">
                  {versions.reduce((acc, v) => acc + v.sections.reduce((a, s) => a + s.items.length, 0), 0)}
                </span>

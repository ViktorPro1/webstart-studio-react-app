// Файл містить конфігурацію меню сайдбару. 
// Розділено на три групи: 
// 1) servicesItems – основні сервіси та генератори; 
// 2) additionalItems – додаткові сервіси, реклами та AI інструменти; 
// 3) aboutItems – сторінки про компанію та контакти.
// Кожен елемент має id, icon, label, path та опційне submenu для підменю.
// Використовується у Sidebar компоненті для генерації навігаційного меню.

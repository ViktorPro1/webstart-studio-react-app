/**
 * Sidebar component
 * Бічне меню для навігації по сайту WebStart Studio.
 * 
 * Містить:
 * - основне меню з посиланнями на сторінки;
 * - підменю (dropdown) для категорій;
 * - додаткові секції: додаткові можливості та платформа;
 * - адаптивну поведінку для мобільних пристроїв.
 *
 * Приймає пропси:
 * - isOpen: boolean – стан відкриття бічного меню;
 * - toggleSidebar: () => void – функція для відкриття/закриття меню.
 */

 ...
 * Відображає сторінку з Умовами використання WebStart Studio.
 * 
 * Містить:
 * - розділи про прийняття умов, опис сервісів, права інтелектуальної власності;
 * - правила використання платформи;
 * - обмеження відповідальності;
 * - конфіденційність, посилання на сторонні платформи та контактну інформацію.
 *
 * Цей компонент статичний і не має пропсів.
 */

 ...
 * AppRoutes.tsx
 *
 * Визначає всі маршрути додатку з використанням React Router v6.
 * Використовує React.lazy та Suspense для лінивого завантаження сторінок,
 * що зменшує розмір початкового бандла та покращує швидкість завантаження.
 *
 * Структура маршрутизації організована за категоріями:
 * - Головна сторінка
 * - Інформаційні сторінки
 * - Портал клієнта
 * - Легальні сторінки (Privacy Policy, Terms of Use)
 * - Генератори
 * - Шаблони
 * - Сервіси
 * - Блог
 ...
 * - 404 сторінка
 *
 * Loader використовується як fallback під час завантаження лінивих компонентів.
 * 
 * Всі маршрути зібрані централізовано для зручності підтримки та масштабування.
 */
